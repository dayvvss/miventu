...
import 'create_speaker_profile_model.dart';
export 'create_speaker_profile_model.dart';

class CreateSpeakerProfileWidget extends StatefulWidget {
  const CreateSpeakerProfileWidget({super.key});

  @override
  State<CreateSpeakerProfileWidget> createState() =>
      _CreateSpeakerProfileWidgetState();
}

class _CreateSpeakerProfileWidgetState
    extends State<CreateSpeakerProfileWidget> {
  late CreateSpeakerProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateSpeakerProfileModel());
    ...
    _model.companyFocusNode!.addListener(() => setState(() {}));
    _model.speakerTopicsController ??= TextEditingController();
    _model.speakerTopicsFocusNode ??= FocusNode();
    _model.speakerTopicsFocusNode!.addListener(() => setState(() {}));
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      TextFormField(
                                        ...
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelText: 'Profession/Expertise',
                                          labelStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelLarge,
                                          hintStyle:
                                      ...
                                      TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          filled: true,
                                          fillColor: (_model.companyFocusNode
                                                      ?.hasFocus ??
                                                  false)
                                              ? FlutterFlowTheme.of(context)
                                                  .accent1
                                      ...
                                      TextFormField(
                                        controller:
                                            _model.speakerTopicsController,
                                        focusNode:
                                            _model.speakerTopicsFocusNode,
                                        autofocus: true,
                                        textCapitalization:
                                            TextCapitalization.words,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelText: 'Speaking Topics',
                                          labelStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelLarge,
                                          hintStyle:
                                        ...
                                        cursorColor:
                                            FlutterFlowTheme.of(context)
                                                .primary,
                                        validator: _model
                                            .speakerTopicsControllerValidator
                                            .asValidator(context),
                                        inputFormatters: [
                                          _model.speakerTopicsMask
                                        ],
                                      ),
                                      TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          filled: true,
                                          fillColor: (_model.emailFocusNode
                                                      ?.hasFocus ??
                                                  false)
                                              ? FlutterFlowTheme.of(context)
                                                  .accent1
                        ...
                        children: [
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await SpeakerProfileRecord.collection
                                    .doc()
                                    .set(createSpeakerProfileRecordData(
                                      name: _model.fullNameController.text,
                                      jobTitle: _model.ageController1.text,
                                ...
                                context.pushNamed('CreateBreakoutRooms');
                              },
                              text: 'Submit Form',
