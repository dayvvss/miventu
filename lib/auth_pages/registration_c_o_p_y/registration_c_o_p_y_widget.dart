...
import 'registration_c_o_p_y_model.dart';
export 'registration_c_o_p_y_model.dart';

class RegistrationCOPYWidget extends StatefulWidget {
  const RegistrationCOPYWidget({super.key});

  @override
  State<RegistrationCOPYWidget> createState() => _RegistrationCOPYWidgetState();
}

class _RegistrationCOPYWidgetState extends State<RegistrationCOPYWidget>
    with TickerProviderStateMixin {
  late RegistrationCOPYModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistrationCOPYModel());
