  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: Padding(
        ...
        child: Container(
          width: MediaQuery.sizeOf(context).width * 0.761,
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed('BreakoutRooms');
                        },
                        child: Container(
                          width: double.infinity,
                          decoration: BoxDecoration(
                              ...
                              child: Row(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      context.pushNamed('UserAccountSettings');
                                    },
                                    child: Container(
                                      width: 50.0,
                                      height: 50.0,
