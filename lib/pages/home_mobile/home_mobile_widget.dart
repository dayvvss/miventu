...
import 'home_mobile_model.dart';
export 'home_mobile_model.dart';
...
class _HomeMobileWidgetState extends State<HomeMobileWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeMobileModel());
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    SelectionArea(
                                        child: Text(
                                      'No upcoming sessions: For the next hour',
                                          ...
                                          children: [
                                            ...
                                            Align(
                                              alignment: AlignmentDirectional(
                                                  -1.0, 0.0),
                                              child: Text(
                                                'No sessions are happening in the \nnext hour.\nView the full schedule to see when \nthe next schedule starts',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
