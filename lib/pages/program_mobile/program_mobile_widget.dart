...
import 'program_mobile_model.dart';
export 'program_mobile_model.dart';

class ProgramMobileWidget extends StatefulWidget {
  const ProgramMobileWidget({super.key});

  @override
  State<ProgramMobileWidget> createState() => _ProgramMobileWidgetState();
}

class _ProgramMobileWidgetState extends State<ProgramMobileWidget> {
  late ProgramMobileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProgramMobileModel());
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            FlutterFlowCheckboxGroup(
                              options: ['Bookmarks', 'Past Content'],
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                SelectionArea(
                                    child: Text(
                                  'All time is in your preferred time zone: ',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Outfit',
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Align(
                                          ...
                                          child: Text(
                                            'Session 1: 2023 Chaos as an opportunity for 2024',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Outfit',
                                      ...
                                      children: [
                                        Align(
                                          alignment:
                                              AlignmentDirectional(-1.0, 0.0),
                                          child: Text(
                                            'Session 2: Strategies to become a digital/omnichannel champion',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Outfit',
