...
import 'useraccountprofile_model.dart';
export 'useraccountprofile_model.dart';

class UseraccountprofileWidget extends StatefulWidget {
  const UseraccountprofileWidget({super.key});

  @override
  State<UseraccountprofileWidget> createState() =>
      _UseraccountprofileWidgetState();
}

class _UseraccountprofileWidgetState extends State<UseraccountprofileWidget>
    with TickerProviderStateMixin {
  late UseraccountprofileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UseraccountprofileModel());
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        context.goNamedAuth(
                            'RegistrationCOPY', context.mounted);
                      },
                      text: 'Log Out',
